/* PrismJS 1.29.0
https://prismjs.com/download.html#themes=prism&languages=markup+css+clike+javascript+bash+diff+go+python+typescript&plugins=toolbar+copy-to-clipboard+match-braces+diff-highlight */
var _self =
